...
Firebase.setInt("users/OXLxTluUlyW4POVaE0womwErvhD3/espDistance",distance);
    ...
    //to calculate the average
      ...
      for(int j = 0; j < (ph_sizeofArray); j++){
       ...
       Firebase.setInt("users/OXLxTluUlyW4POVaE0womwErvhD3/avgPH",ph_avg);
       ph_temp = 0;
...
//          Serial.println(i);
      ...
      Serial.print("Day avg= ");
       ...
       Firebase.setInt("users/OXLxTluUlyW4POVaE0womwErvhD3/avgPD",pd_avg);
       pd_temp = 0;
...
//          Serial.println(i);
      ...
      Serial.print("Week avg= ");
       ...
       Firebase.setInt("users/OXLxTluUlyW4POVaE0womwErvhD3/avgPW",pw_avg);
       pw_temp = 0;
        for(int j = 0; j < (pw_sizeofArray); j++){
         water_level_PW [j] = 0;
          }
